...
Home.get('/', (c) => {
  const title = 'API de SC'
  const description =
    "L'API de SC offre un accès complet aux fonctionnalités de la plateforme, permettant une intégration simple et efficace de nos services."
          ...
          <div class="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-8 gap-2 sm:gap-0 relative grid-flow-row">
            ...
            >
              <div class="flex flex-col">
                ...
                <span class="text-neutral-200 font-bold text-lg sm:text-xl md:text-2xl mt-2">API de SC</span>
